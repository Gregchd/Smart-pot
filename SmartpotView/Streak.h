...
namespace SmartpotView {
	...
	/// Summary for Streak
	/// </summary>
	public ref class Streak : public System::Windows::Forms::Form
	{
	public:
		Streak(void)
		{
	...
	private: System::Windows::Forms::Button^ streakText;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Streak::typeid));
			this->label1 = (gcnew System::Windows::Forms::Label());
			this->label2 = (gcnew System::Windows::Forms::Label());
			this->label3 = (gcnew System::Windows::Forms::Label());
			this->streakText = (gcnew System::Windows::Forms::Button());
			this->SuspendLayout();
			// 
			// label1
			// 
			...
			this->label3->Location = System::Drawing::Point(119, 126);
